...
<section class="jumbotron text-center">
  <div class="container">
    <h1 class="jumbotron-heading">Açtığınız Başlıklar</h1>
      <p class="lead text-muted">Açtığınız tüm başlıkları burada bulabilirsiniz.</p>
    </div>
  </section>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <div class="row">
        ...
        $sorgu=$db->prepare("select * from vt_basliklar WHERE vt_kullid = {$kullanicicek['vt_id']}");
        $sorgu->execute();
        ...
        $iceriksor=$db->prepare("select * from vt_basliklar WHERE vt_kullid = {$kullanicicek['vt_id']} order by vt_id DESC limit $limit,$sayfada");
        $iceriksor->execute();
